...
cookie2=dict(token='ea566ddec685abf0a2caeb79d5883831',random='79420')
for i in range(0,30):
	...
	r=requests.get("http://10.7.1.34:5050/app/eventinfo/")
	#r=requests.get("http://10.7.1.34:5050/static/m/views/login.html?id=41")
	cookie3=dict(token=r.cookies['token'],random=r.cookies['random'])
	s=requests.post("http://10.7.1.34:5050/acc/cuslog/",data=p,cookies=cookie3)
